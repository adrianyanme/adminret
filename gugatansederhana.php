  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
          <div class="container-fluid">
              <div class="row mb-2">
                  <div class="col-sm-6">
                      <h1 class="m-0">Gugatan Sederhana</h1>
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="container-fluid">
              ...
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title">Gugatan Sederhana List</h3>
                  </div>
                  <div class="card-body">
                      <table id="gugatansederhanaTable" class="table table-bordered table-striped">
                          <thead>
                              <tr>
                                  <th>ID</th>
                                  <th>Email</th>
...
$(document).ready(function() {
    ...
    var table = $('#gugatansederhanaTable').DataTable({
        ...
        "columns": [
            ...
            { "data": "nama_tergugat" },
            { "data": "penjelasan" },
            { "data": "tuntutan_pengugat" },
            { 
                "data": "lampiran",
                "render": function(data, type, row) {
                    var url = `http://143.198.218.9/backend/storage/lampiran/${data}`;
